...
*
* It is designed for use with the backend_ym.js and provides the "realtime" raw VU data of the 
* underlying voices corresponding to the music played via WebAudio.
*
...
* stuff to a backend specific subclass of AbstractTicker. The below YmTracer is such a subclass.
*
* Functionality:
*
...
*/
YmTracer = (function(){ var $this = function(outputSize) { 
		$this.base.call(this);
	...
	// ------------ APIs expected by the base infractructure - see doc in AbstractTicker parent class -----------------
		...
		/*
		* Basic initialization: 3 kinds of add-on data (voice 1-3) are use here, and for each of these
		...
		*/
		resampleData: function(sampleRate, inputSampleRate, inputLen, backendAdapter) {
			...
			this._resample(backendAdapter.getVolumeVoice0(), inputLen, this._resampleV1, resampleLen, backendAdapter);
			this._resample(backendAdapter.getVolumeVoice1(), inputLen, this._resampleV2, resampleLen, backendAdapter);
			this._resample(backendAdapter.getVolumeVoice2(), inputLen, this._resampleV3, resampleLen, backendAdapter);
		},
		/**
	...
	// ------------ API specifically provided by YmTracer (invent whatever accessors you need here) -----------------
